...
async def init_db() -> None:
    ...
    async with engine.begin() as conn:
        ...
        migrations = [
            ...
            "ALTER TABLE chats ADD COLUMN IF NOT EXISTS report_mode VARCHAR(32) DEFAULT 'admin_only'",
            "ALTER TABLE chats ADD COLUMN IF NOT EXISTS send_suspicious_to_admin BOOLEAN DEFAULT TRUE",
